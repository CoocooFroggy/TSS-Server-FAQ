...
3. Download [this text file](https://coocoofroggy.github.io/TSS-Server-FAQ/cloak.txt) and save it somewhere accessible to the native Files app.
...
7. Toggle the switch on, and select the `cloak.txt` file you downloaded in step 3.
